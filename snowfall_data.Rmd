---
title: "Anchorage Snowfall Tracker"
author: "Ben Matheson"
date: "`r Sys.Date()`"
output: 
  html_document: 
...
daily_url_2024 <- "https://www.ncei.noaa.gov/cdo-web/api/v2/data/?datasetid=GHCND&stationid=GHCND:USW00026451&startdate=2024-01-01&enddate=2024-06-01&limit=999&datatypeid=SNOW&datatypeid=SNWD&units=standard"
...
snow_summary <- snow %>% group_by(winter_season) %>%  summarize(max_cumulative = max(snow_rolling)) %>% ungroup()
...
## 2023-2024 in Anchorage cumulative snowfall compared to winters since 1952.
